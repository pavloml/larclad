                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="form-group mt">
                                ...
                                <input type="date" class="form-control" name="banned_until" id="bannedUntil" min="{{ now()->toDateString() }}" required>
                                @error('banned_until')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="reason" maxlength="160" class="form-control" name="reason" required>{{ old('reason') }}</textarea>
                                @error('reason')
                                <x-form-error-message :message="$message"/>
                                @enderror
                            </div>
