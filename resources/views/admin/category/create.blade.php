            ...
            <div class="col-12 col-md-4 mt-3 mt-md-0">
                <div class="card">
                    <div class="card-header">
                        <div class="h4">Add a category</div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="price-field-available" id="priceFieldYes" value="1">
                                        <label class="form-check-label" for="priceFieldYes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" checked type="radio" name="price-field-available" id="priceFieldNo" value="0">
