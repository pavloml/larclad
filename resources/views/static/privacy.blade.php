<x-layout title="Privacy policiy">
    <p class="h1 text-danger text-center">This is only an example</p>
    <p class="h2 text-danger text-center">Replace it with the actual privacy policy for the production use</p>
    <h1 class="h2 text-center">Privacy Policy for {{ @config('app.name') }}</h1>
