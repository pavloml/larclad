...
class EmailUpdatedNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject(__('Email updated'))
            ->line(__('The email associated with your account was changed.'))
    ...
    {
        return [
            'message' => __('The email associated with your account was changed. Please contact administrator if you did not authorize this change.')
        ];
    }
}
